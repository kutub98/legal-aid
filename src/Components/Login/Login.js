...
import './Login.css';
const Login = () => {
  const { LoginWithEp, loginWithGoogleProvider, loginWithGitHub } =
  ...
  return (
    <div className="loginBox">
      <div className="loginForm lg:w-1/2 w-full">
        <div className="w-full my-5  p-8 space-y-3 rounded-xl bg-gray-200 text-gray-800">
          <h1 className="text-2xl font-bold text-center">Login</h1>
          <form
            onSubmit={loginWithEpHandling}
          ...
          >
            ...
            <div className="space-y-1 text-sm">
              ...
              <div className="flex justify-end text-xs text-gray-600">
                <p
                  ...
                  className=" text-underline text-yellow-700 cursor-pointer "
                >
                  Forgot Password?
                </p>
              </div>
            ...
            <button
              type="submit"
              className="block w-full rounded p-3 text-center rounded-sm text-gray-50 bg-yellow-800 hover:bg-slate-900"
            >
              Sign in
            </button>
          </form>
      ...
      <div className="my-5 LoginAnimation lg:w-1/2 w-full">
