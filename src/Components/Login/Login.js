...
import "./Login.css";
const Login = () => {
  const { auth, user, LoginWithEp, loginWithGoogleProvider, loginWithGitHub } = useContext(AuthContext);
console.log(user)
...
const loginWithEpHandling =(e)=>{
    ...
    .then(res => {
        ...
        Swal.fire({
            position: 'center',
            icon: 'success',
            title: 'Welcome to our Legal Aid Service',
    ...
    <div className="loginBox">
      <div className="loginForm w-1/2">
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-200 text-gray-800">
          ...
          <form onSubmit={loginWithEpHandling} className="space-y-6 ng-untouched ng-pristine ng-valid">
            ...
            <div className="space-y-1 text-sm">
              ...
              <div className="flex justify-end text-xs text-gray-600">
                <p onClick={resetPassword} className=" text-underline text-yellow-700 cursor-pointer ">
                  Forgot Password?
                </p>
              </div>
            </div>
            <button type="submit" className="block w-full p-3 text-center rounded-sm text-gray-50 bg-yellow-800 hover:bg-slate-900">Sign in</button>
          </form>
      ...
      <div className="LoginAnimation w-1/2">
